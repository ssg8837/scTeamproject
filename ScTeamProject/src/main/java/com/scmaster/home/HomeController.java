...
public class HomeController 
{
	...
	public @ResponseBody String login( String userid, String userpwd) 
	{
		...
		if(user!=null)
		{
			...
			httpSession.setAttribute("loginAddr",user.getUserAddr());
			httpSession.setAttribute("loginPhone",user.getUserPhone());
			httpSession.setAttribute("loginEmail",user.getUserEmail());
