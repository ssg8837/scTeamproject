...
public class CityController 
{
	...
	@RequestMapping(value = "/location_input", method = RequestMethod.GET, produces = "text/html;charset=utf8")
	...
	@RequestMapping(value = "/location_delete", method = RequestMethod.GET, produces = "text/html;charset=utf8")
