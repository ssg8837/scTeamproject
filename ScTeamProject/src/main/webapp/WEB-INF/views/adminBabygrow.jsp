...
<html>
	...
	<script src="./resources/js/grow/babygrow.js"></script>
	<link href="./resources/css/grow/babygrow.css" rel="stylesheet">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Admin Baby Grow</h3>
        <div class="row mt">
          <div class="col-lg-12">
          	<div class="adminbabygrow"></div>
			<div class="babygrow_style">
				<div>성별 : <input type="text" id="GENDER" placeholder="M or F"></div></br>
				<div>개월 : <input type="text" id="AGE"></div></br>
				<div>키 : <input type="text" id="HEIGHT"></div></br>
				<div>몸무게 : <input type="text" id="WEIGHT"></div></br>
				<div>머리둘레 : <input type="text" id="HEAD"></div></br>
				<input type="hidden" id="BMI">
				<input type="button" class="babygrow_data" value="성장기록입력">
				<input type="button" class="babygrow_del" value="성장기록삭제">
          	</div>	
          </div>
        </div>
      </section>
