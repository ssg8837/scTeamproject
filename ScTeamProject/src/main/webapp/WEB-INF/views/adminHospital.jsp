...
<html>
	...
	<script src="./resources/js/hospital_location/hospital_location.js"></script>
	<link href="./resources/css/hospital_location/hospital_location.css" rel="stylesheet">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Admin Hospital & Location</h3>
        <div class="row mt">
          <div class="col-lg-12">
			<div class="h_l_style">
          		<input type="button" value="병원입력" class="hospital_input">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          		<input type="button" value="병원삭제" class="hospital_delete">
          		</br></br>
          		<div class="adminHospital"></div>
          		<input type="button" value="지역코드입력" class="location_input">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          		<input type="button" value="지역코드삭제" class="location_delete">
          		<div class="adminLocation"></div>
          	</div>	
          </div>
        </div>
      </section>
