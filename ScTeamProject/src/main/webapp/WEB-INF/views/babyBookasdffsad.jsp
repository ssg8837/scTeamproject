...
<html>
	<head>
		...
		<link href="./resources/css/bootstrap/daterangepicker.css" rel="stylesheet">
    ...
    <!--footer end-->
	    ...
	    <script src="./resources/js/bootstrap-fileupload.js" type="text/javascript" ></script>
	   ...
	   <!--  <script src="./resources/js/bootstrap-datepicker.js" type="text/javascript" ></script>
	    ...
	    <script src="./resources/js/bootstrap-timepicker.js" type="text/javascript" ></script>
