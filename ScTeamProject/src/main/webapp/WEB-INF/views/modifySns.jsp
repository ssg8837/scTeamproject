      ...
      <section class="wrapper site-min-height">
        ...
        <div class="row mt">
          ...
          <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="updateNewSns" method="post" action="updateNewSns">
                <c:if test="${sns.photoCount gt 0 }">
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                        <img src="./getImageSns?fullname=${sns.photo_1}" alt="">
                      </div>
				</c:if>                  
                <c:if test="${sns.photoCount gt 1 }">
                      <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                        <img src="./getImageSns?fullname=${sns.photo_2}" alt=""></div>
                  </c:if>
				...
				<input type="hidden" value="${sns.SNSNo }" id="snsNo" name="snsNo">
                  <div class="form-group ">
                    <label for="content" class="control-label col-lg-2">내용</label>
                    <div class="col-lg-10">
                      <textarea class="form-control " id="content" name="content" rows="8" style="resize:none;" required>${sns.content }</textarea>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="permission" class="control-label col-lg-2">전체공개</label>
                    <c:if test="${sns.permission == 1 }">
	                  <input id="permission" name="permission" type="checkbox" checked="checked" data-toggle="switch" /></c:if>
                    <c:if test="${sns.permission == 0 }">
	                  <input id="permission" name="permission" type="checkbox" data-toggle="switch" /></c:if>
