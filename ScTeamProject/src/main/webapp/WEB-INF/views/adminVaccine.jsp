...
<html>
	...
	<script src="./resources/js/forVaccine/adminvaccine.js"></script>
	<link href="./resources/css/forVaccine/adminvaccine.css" rel="stylesheet">
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Admin Vaccine</h3>
        <div class="row mt">
          <div class="col-lg-12">
			<div class="adminvaccine_style">
          		<div>DISEASENUM : <input type="text" id="DISEASENUM"></div></br>
          		<div>DISEASENAME : <input type="text" id="DISEASENAME"></div></br>
          		<div>VACCINETYPE : <input type="text" id="VACCINETYPE"></div></br>
          		<div>DISEASECONTENT</div></br>
          		<textarea rows="10" cols="35" id="DISEASECONTENT"></textarea></br></br>
          		<div>VACCINEDATE : <input type="text" id="VACCINEDATE"></div></br></br>
        		<input type="button" class="adminvaccine_data" value="질병기록입력">
				<input type="button" class="adminvaccine_del" value="질병기록삭제">
          	</div>
          	<div class="adminbabygrow"></div>	
          </div>
        </div>
      </section>
      <!-- /wrapper -->
