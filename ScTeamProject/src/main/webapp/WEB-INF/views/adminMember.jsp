...
<html>
	<head>
		...
		<link href="./resources/fonts/font-awesome/css/font-awesome.css" rel="stylesheet">
			...
			<script src="./resources/js/home/adminmember.js"></script>
			<link href="./resources/css/login/adminmember.css" rel="stylesheet">
	</head>
    ...
    <section id="main-content">
      <section class="wrapper site-min-height">
        <h3><i class="fa fa-angle-right"></i> Admin UserInfo</h3>
        <div class="row mt">
          <div class="col-lg-12">
            	<table border="1">
            		<tr>
            	...
            	<div style="text-align: center;">
             	...
             	<table>
             		<tr>
             			<td><input type="text" id="search" value="${search }">
             			<input type="button" value="유저번호" onclick="pagingFormSubmit(1)"></td>
             		</tr>
             	</table>  
          </div>
        </div>
