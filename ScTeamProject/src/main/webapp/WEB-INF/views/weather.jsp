...
<html>
    ...
    <section id="main-content">
      <section class="wrapper site-min-height"  style="padding: 0;">
        <h3><i class="fa fa-angle-right" style="padding-top: 1px; padding-left: 15px;"></i> 오늘의 날씨</h3>
        <div class="row mt">
          <div class="col-lg-12">
